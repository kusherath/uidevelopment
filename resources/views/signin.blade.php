    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        ...
        <li class="dropdown"><a href="#"><span>LKR</span> <i class="bi bi-chevron-down"></i></a>
          ...
          <li><a class="nav-link scrollto" href="#about">All Courcess</a></li>
          <li><a class="nav-link scrollto" href="#services">All Tution Classes</a></li>
          <li><a class="nav-link scrollto" href="#portfolio">Do You Like to Teach?</a></li>
...
<article class="card-body mx-auto" style="max-width: 400px;">
    ...
    <p class="text-center">Have'nt an account? <a href="{{ route('register') }}">Register Here</a> </p> 
